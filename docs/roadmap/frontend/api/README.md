...
| RSS 订阅 rss ✨2026-09-24 | `rss.ts` | RSS 订阅 Phase 1：订阅源 CRUD/手动刷新/文章分页/推送下载器（savePath/tags/downloaderId 覆盖）；`RssPage<T>` 统一 list/total/pageSize 信封（feature rss-subscription-2026-09-24） |
