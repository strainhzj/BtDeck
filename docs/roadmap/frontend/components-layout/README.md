...
> ⚠ 2026-09-20 P6-5：`CompactTable.vue`（全仓零消费方死代码，70 处中文）已删除；全仓 Options API 技术债剩余 2 处。
...
- **范式分布**：本分支仍以 class-component 为主（原唯一 Options API `CompactTable.vue` 已于 2026-09-20 P6-5 作为零消费方死代码删除）
