...
- W3-①（本批，只读 + 唯一 DB 写）：torrent_advanced_search、
  advanced_search_template_create、dashboard_get；
- W3-②（写/高风险）：torrent_mark_pending_delete、cron_task_trigger；
...
def register_all() -> None:
    ...
    from app.mcp.tools.torrents import handle_advanced_search
