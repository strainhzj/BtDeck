...
class AuditOperationType(str, Enum):
    ...
    MCP_APIKEY_ROTATE = "mcp_apikey_rotate"  # MCP 服务密钥生成/刷新（mcp-service-capabilities W5/G11）
    MCP_APIKEY_VIEW = "mcp_apikey_view"  # MCP 服务密钥明文查看（mcp-service-capabilities W5）
