...
def get_default_tracker_keywords() -> List[Dict[str, Any]]:
    ...
    return [
        # ========== 成功池 ==========
        {"keyword_type": "success", "keyword": "Success", "description": "Tracker连接成功"},
        # ========== 失败池 ==========
        {"keyword_type": "failed", "keyword": "Bad Gateway", "description": "网关错误"},
        {"keyword_type": "failed", "keyword": "Could not connect to tracker", "description": "无法连接到tracker"},
        {"keyword_type": "failed", "keyword": "Forbidden", "description": "禁止访问"},
        {"keyword_type": "failed", "keyword": "Internal Server Error", "description": "服务器内部错误"},
        {
            "keyword_type": "failed",
            "keyword": "Invalid credentials 3! Re-download the .torrent",
            "description": "凭据无效，需要重新下载种子",
        },
        {"keyword_type": "failed", "keyword": "Not Found", "description": "资源未找到"},
        {"keyword_type": "failed", "keyword": "Please delete this tracker!", "description": "请删除此tracker"},
        {"keyword_type": "failed", "keyword": "Request too frequent(h)", "description": "请求过于频繁"},
        {"keyword_type": "failed", "keyword": "Require passkey", "description": "需要passkey"},
        {
            "keyword_type": "failed",
        ...
        {"keyword_type": "failed", "keyword": "Torrent not exists", "description": "种子不存在"},
        {"keyword_type": "failed", "keyword": "Torrent not exists (0.001339384)", "description": "种子不存在"},
        {"keyword_type": "failed", "keyword": "Torrent not exists (0.001526497)", "description": "种子不存在"},
        {"keyword_type": "failed", "keyword": "Torrent not exists (0.001741931)", "description": "种子不存在"},
        {"keyword_type": "failed", "keyword": "Torrent not exists (0.001883446)", "description": "种子不存在"},
        {"keyword_type": "failed", "keyword": "Torrent not found.", "description": "种子未找到"},
        {
            "keyword_type": "failed",
            "keyword": "Torrent not registered with this tracker",
            "description": "种子未在此tracker注册",
        },
        {"keyword_type": "failed", "keyword": "Tracker HTTP response 0 (No Response)", "description": "Tracker无响应"},
        {
            "keyword_type": "failed",
            "keyword": "Tracker HTTP response 301 (Moved Permanently)",
            "description": "Tracker永久重定向",
        },
        {"keyword_type": "failed", "keyword": "Tracker HTTP response 302 (Found)", "description": "Tracker临时重定向"},
        {
            "keyword_type": "failed",
            "keyword": "Tracker HTTP response 403 (Forbidden)",
            "description": "Tracker禁止访问",
        },
        {"keyword_type": "failed", "keyword": "Tracker HTTP response 404 (Not Found)", "description": "Tracker未找到"},
        {
            "keyword_type": "failed",
        ...
        {"keyword_type": "failed", "keyword": "Tracker did not respond", "description": "Tracker未响应"},
        {"keyword_type": "failed", "keyword": "Tracker in system maintaining", "description": "Tracker系统维护中"},
        {
            "keyword_type": "failed",
        ...
        {"keyword_type": "failed", "keyword": "err torrent banned", "description": "种子被禁止"},
        {
            "keyword_type": "failed",
        ...
        {"keyword_type": "failed", "keyword": "torrent banned", "description": "种子被禁止"},
        {"keyword_type": "failed", "keyword": "torrent error A", "description": "种子错误A"},
        {"keyword_type": "failed", "keyword": "torrent not exists", "description": "种子不存在"},
        {
            "keyword_type": "failed",
            "keyword": "torrent not registered with this tracker",
        ...
        {"keyword_type": "failed", "keyword": "unregistered torrent", "description": "未注册的种子"},
        {
            "keyword_type": "failed",
        ...
        {"keyword_type": "failed", "keyword": "您已在 www.hdkylin.top 汇报过了", "description": "已在其他站点汇报过"},
        {
            "keyword_type": "failed",
            "keyword": "您已经在一个客户端做种。一次只能从一个位置做种种子.",
            "description": "已在一个客户端做种",
        },
        {"keyword_type": "failed", "keyword": "种子已被删除或尚未发布", "description": "种子已被删除或尚未发布"},
        {"keyword_type": "failed", "keyword": "该种子已被禁止。", "description": "种子已被禁止"},
        {
            "keyword_type": "failed",
        ...
        # ========== 忽略池 ==========
        {"keyword_type": "ignored", "keyword": "<none>", "description": "空消息，忽略处理"},
    ]
...
def init_default_tracker_keywords(db) -> None:
    ...
    # 查询数据库中已存在的关键词
    existing_keywords = {
        kw.keyword for kw in db.query(TrackerKeywordConfig.keyword).filter(TrackerKeywordConfig.dr == 0).all()
    }
