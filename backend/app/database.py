...
def init_db():
    ...
    try:
        ...
        from app.tasks.cron_models import (  # noqa: F811 与上方 line 97 冗余，保留以降低本独立 try 块对顶部 import 顺序的耦合
            CronTask,
        )
    ...
    try:
        from app.models.notification import (  # noqa: F811 与上方 line 100 冗余，保留以降低本独立 try 块对顶部 import 顺序的耦合
            Notification,
        )
