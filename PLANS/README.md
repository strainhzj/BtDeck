...
| 计划 | 范围 | 状态 |
|------|------|------|
| [MCP 服务与可选能力开放](./mcp-service-capabilities.md) | 同进程 MCP、全局/逐能力开关、统一认证、Tracker/路径脱敏、六项首批工具与 G0～G11 实现门禁 | 📝 待实施（2026-09-05 基线复核修订，W0 待启动）；feature `mcp-service-capabilities-2026-08-28` |
