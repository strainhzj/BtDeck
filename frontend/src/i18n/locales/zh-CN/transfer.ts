...
export const transfer = {
  ...
  deleteSource: '删除原种子',
  deleteSourceHint: '勾选后，转移成功会删除原下载器中的种子（需二次确认）',
  cancel: '取消',
  submit: '确定',
  submitting: '转移中...',
  deleteConfirmTitle: '确认删除原种子',
  deleteConfirmDone: '种子已成功转移到目标下载器',
  deleteConfirmQuestion: '是否删除原下载器中的种子？',
  deleteConfirmIrreversible: '此操作不可逆，请谨慎选择',
  deleting: '删除中...',
  confirmDelete: '确认删除',
  continueConfirm: '勾选"删除原种子"后，转移成功会自动删除原下载器种子，请谨慎操作',
  batchContinueConfirm: '勾选"删除原种子"后，转移成功会自动删除原下载器种子，请谨慎操作。是否继续？',
  ...
  msg: {
    ...
    success: '种子转移成功',
    successWithDelete: '种子转移成功，原种子已删除',
    failed: '种子转移失败',
    failedWith: '种子转移失败: {message}',
    failedRetry: '种子转移失败，请稍后重试',
    deleteSourceFailed: '删除原种子失败',
    noTorrents: '未选择任何种子',
    missingSourceDownloader: '无法获取源下载器信息',
    batchFailed: '批量转移失败',
    batchFailedWith: '批量转移失败: {message}',
    deletingSource: '正在删除原种子...',
    batchSuccessDeleted: '批量转移完成，已成功删除 {count} 个原种子'
  },
  setLocation: {
